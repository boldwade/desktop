...
export const ICON_ARROW_LEFT_CLOSED = require('~/renderer/resources/icons/arrow-left-closed.svg');
export const ICON_ARROW_RIGHT_CLOSED = require('~/renderer/resources/icons/arrow-right-closed.svg');
