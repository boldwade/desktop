...
export const darkTheme: ITheme = {
  ...
  'tab.active.backgroundColor': '#2B97F0',
  'tab.inactive.backgroundColor': '#000',
  'tab.selected.textColor': '#fff',
